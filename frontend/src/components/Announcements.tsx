    ...
    <div className='bg-white p-4 rounded-md'>
        ...
        <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="bg-SkyLight rounded-md p-4">
                ...
                <p className="text-sm text-gray-400 mt-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Et laboriosam magni pariatur possimus consequuntur esse.</p>
