    ...
    <div className='flex flex-col flex-1 p-4 gap-4 xl:flex-row'>
        ...
        <div className="w-full xl:w-2/3">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="flex flex-1 gap-4 rounded-md px-4 py-6 bg-Sky">

                    <div className="w-1/3">
                    
                        <Image src="/Amirhosein-Imani.png" alt="" width={144} height={144} className="w-36 h-36 rounded-full object-cover" />
